...
public class GLHelper {
    ...
    /**
     * Create program from vertex and fragment shader resource id
     *
     * @param context
     * @param vertexShaderResourceId   The vertex resource ID of the raw text file about to be turned into a shader.
     * @param fragmentShaderResourceId The fragment resource ID of the raw text file about to be turned into a shader.
     * @return
     */
    ...
    /**
     * Create Program from vertex and fragment shader resource id and attrs lists
     *
     * @param context
     * @param vertexShaderResourceId   The vertex resource ID of the raw text file about to be turned into a shader.
     * @param fragmentShaderResourceId The fragment resource ID of the raw text file about to be turned into a shader.
    ...
    /**
     * Create program from vertex and fragment shader ids
     *
